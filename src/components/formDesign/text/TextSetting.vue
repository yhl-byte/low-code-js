 ...
 * @LastEditTime: 2023-06-08 17:43:44
 * @FilePath: /low-code-js/src/components/formDesign/text/TextSetting.vue
-->
<template>
  <a-form :model="form" label-align="left" auto-label-width>
    <div class="gapStyle">单行文本 - 基础配置</div>
    ...
    <a-form-item field="name" label="格式">
      <a-select placeholder="Please select ...">
        <a-option>无</a-option>
        <a-option>手机</a-option>
        <a-option>邮箱</a-option>
        <a-option>网址</a-option>
        <a-option>身份证</a-option>
      </a-select>
    </a-form-item>
    <a-form-item field="name" label="清除按钮" class="rightCom">
      <a-switch v-model="form.clearable" />
    </a-form-item>
    <a-form-item field="name" label="显示计数器" class="rightCom">
      <a-switch v-model="form.showlimit" />
    </a-form-item>
    <a-form-item v-if="form.showlimit" field="name" label="字数上限">
      <a-input-number v-model="form.maxLength" placeholder="Please Enter" class="input-demo" :min="1" :max="1000"/>
    </a-form-item>
    <div class="gapStyle">校验</div>
    <a-form-item field="isRead" label="必填" class="rightCom">
      <a-checkbox />
    </a-form-item>
    <a-form-item field="isRead" label="最大长度" class="rightCom">
      <a-checkbox />
    </a-form-item>
    <a-form-item field="isRead" label="最小长度" class="rightCom">
      <a-checkbox />
    </a-form-item>
