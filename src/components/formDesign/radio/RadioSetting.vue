 ...
 * @LastEditTime: 2023-06-08 17:49:12
 * @FilePath: /low-code-js/src/components/formDesign/radio/RadioSetting.vue
-->
<template>
  <a-form :model="form" label-align="left" auto-label-width>
    <div class="gapStyle">单选 - 基础配置</div>
...
const delData = (i) => {
  if (form.value.diyList) {
    ...
    if (form.value.defaultValue === form.value.diyList[i].value) {
      ...
      form.value.diyList.forEach((element) => {
